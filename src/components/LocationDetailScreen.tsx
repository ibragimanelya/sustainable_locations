...
const LocationDetailScreen = () => {
    ...
    useEffect(() => {
        fetchLocation(parseInt(locationId)).then(res => {
            setLocation(res);
        }).catch(e => {
            setError(e.message);
    ...
    return (
        <div>
            <div className="card m-2 m-md-4">
                ...
                <div className="row">
                    <div className="col-7">
                        ...
                        <p className="text-start">{'Date: ' + new Date(location.date).toLocaleDateString('de-DE')}</p>
                        ...
                        <p className="text-start">{'Time category: ' + location.time_category}</p>
                    </div>
                    <div className="col-4">
                        <img
            ...
            <div className="m-2 m-md-4">
                <button className="btn btn-info text-white m-2" onClick={() => navigate("/locations")}>Back to overview</button>
